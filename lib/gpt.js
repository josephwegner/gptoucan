...
if (true && process.env.NODE_ENV === 'development') {
  async function test() {
    // run_vNKI5XcPyQGqE7IT8oP6iuHA
    // thread_1L66TF7V5EiqBR0LrgYcq9kI
    console.log(await openai.beta.threads.runs.retrieve('thread_ZspDJSBvNhCFiCDowNGustrS', 'run_iXPk2Pvt6yLgX6NcGmJaiggI'))
  }
  test()
}